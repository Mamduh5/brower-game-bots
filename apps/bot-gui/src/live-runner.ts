    ...
    if (type === "action.executed") {
      ...
      if (readString(payload, "semanticActionId") === "execute-chess-move" && Object.keys(semanticParams).length > 0) {
        latestChess = {
          ...
          searchDepth: numberAt(semanticParams, "searchDepth"),
          evaluatedNodeCount: numberAt(semanticParams, "evaluatedNodeCount"),
          ...
          materialBalanceAfter: numberAt(semanticParams, "materialBalanceAfter"),
          repetitionCount: numberAt(semanticParams, "repetitionCount"),
          givesCheck: booleanAt(semanticParams, "givesCheck"),
          givesCheckmate: booleanAt(semanticParams, "givesCheckmate"),
          avoidsStalemate: booleanAt(semanticParams, "avoidsStalemate"),
